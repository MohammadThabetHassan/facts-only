...
const EN = {
  ...
  "explain.strength": "Based on {n} observation(s); placement score {score} (flagged at {at}).",
  "explain.strengthNarrow": "This is just over the line — read the signals before treating it as settled.",
  "explain.strengthDecisive": "Based on a paid-content label found on the page itself.",
  "explain.because": "Why:",
...
const AR = {
  ...
  "explain.strength": "استنادًا إلى {n} ملاحظة؛ درجة الزرع {score} (يُشار عند {at}).",
  "explain.strengthNarrow": "النتيجة قريبة من الحد — اقرأ الإشارات قبل اعتبار الأمر محسومًا.",
  "explain.strengthDecisive": "استنادًا إلى وسم محتوى مدفوع وُجد في الصفحة نفسها.",
