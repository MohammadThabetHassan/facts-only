...
//
// Usage:
//   GITHUB_TOKEN=github_pat_… GITHUB_REPO=MohammadThabetHassan/factlens \
...
async function bootstrapIfEmpty() {
  ...
  const content = Buffer.from(
    ...
    "The full FactLens history follows this commit (see docs/VERIFICATION.md)."
  ).toString("base64");
  const res = await fetch(`${API}/contents/.factlens-bootstrap`, {
    method: "PUT",
    headers: { ...HEADERS, "Content-Type": "application/json" },
    body: JSON.stringify({
