...
// Facts Only pipeline against a real AI provider.
//
// Usage (from the repo root):
//   FACTS_ONLY_GEMINI_KEY=… node scripts/live-check.mjs
//   FACTS_ONLY_PROVIDER=openrouter FACTS_ONLY_OPENROUTER_KEY=… FACTS_ONLY_OPENROUTER_MODEL=auto-free \
//     node scripts/live-check.mjs
//   FACTS_ONLY_SECOND_PROVIDER=openrouter FACTS_ONLY_SECOND_KEY=… …   # + cross-model check
//
...
const PROVIDER = process.env.FACTS_ONLY_PROVIDER || "gemini";
const KEY = process.env.FACTS_ONLY_GEMINI_KEY;
const OR_KEY = process.env.FACTS_ONLY_OPENROUTER_KEY;
const SECOND_PROVIDER = process.env.FACTS_ONLY_SECOND_PROVIDER || "none";
const SECOND_KEY = process.env.FACTS_ONLY_SECOND_KEY;

if (PROVIDER === "gemini" && !KEY) {
  console.error(`Missing FACTS_ONLY_GEMINI_KEY.

Get a free key (2 minutes):
  1. https://aistudio.google.com/apikey
  2. "Create API key" → copy
  3. Run:  FACTS_ONLY_GEMINI_KEY=your-key node scripts/live-check.mjs
     (Windows PowerShell:  $env:FACTS_ONLY_GEMINI_KEY="your-key"; node scripts/live-check.mjs)

OpenRouter: FACTS_ONLY_PROVIDER=openrouter FACTS_ONLY_OPENROUTER_KEY=your-or-key \
FACTS_ONLY_OPENROUTER_MODEL=auto-free node scripts/live-check.mjs
`);
  process.exit(1);
}
if (PROVIDER === "openrouter" && !OR_KEY) {
  console.error(`Missing FACTS_ONLY_OPENROUTER_KEY.

Run:  FACTS_ONLY_PROVIDER=openrouter FACTS_ONLY_OPENROUTER_KEY=your-or-key FACTS_ONLY_OPENROUTER_MODEL=auto-free node scripts/live-check.mjs
`);
  process.exit(1);
}
...
const settings = {
  provider: PROVIDER,
  geminiKey: KEY || "",
  geminiModel: process.env.FACTS_ONLY_GEMINI_MODEL || "gemini-2.5-flash",
  openrouterKey: process.env.FACTS_ONLY_OPENROUTER_KEY || "",
  openrouterModel: process.env.FACTS_ONLY_OPENROUTER_MODEL || "auto-free",
