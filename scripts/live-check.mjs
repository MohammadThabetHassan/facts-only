...
// FactLens pipeline against the real Gemini API (with Google Search grounding).
//
// Usage (from the repo root):
//   FACTLENS_GEMINI_KEY=... node scripts/live-check.mjs
//   FACTLENS_GEMINI_MODEL=gemini-2.5-flash   # optional, this is the default
//
...
try {
  ...
  const problems = [];
  if (!report.method.searchUsed) problems.push("search grounding was not used");
