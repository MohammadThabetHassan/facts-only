...
FactLens is a security-adjacent tool, so these classes of issues are in scope:
...
- The accuracy of individual AI verdicts (FactLens is explicitly evidence, not
